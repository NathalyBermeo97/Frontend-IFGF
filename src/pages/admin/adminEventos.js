...
const baseUrl = "https://backend-ifgf.herokuapp.com/api/events/";
            ...
            .then((response) => {
                ...
                dataNueva.map((consola) => {
                    if (consolaSeleccionada._id === consola._id) {
                        ...
                        consola.schedule = consolaSeleccionada.schedule;
                        consola.cost = consolaSeleccionada.cost;
                    }
                });
                setData(dataNueva);
                    ...
                    <TableBody>
                        {data.map((consola) => (
                            <TableRow key={consola._id}>
                                ...
                                <TableCell>{consola.ubication}</TableCell>
                                <TableCell>{consola.schedule}</TableCell>
                                <TableCell>{consola.cost}</TableCell>
                                <TableCell>
                                    <Edit
