                ...
                <div >
                    <div className="row">
                        ...
                        <div className="col-lg-10 " >
                            <div className="App">
                                <br /><br /><br />
                                <button className="btn btn-primary" onClick={()=>{this.setState({form: null, tipoModal: 'insertar'}); this.modalInsertar()}}>Agregar Video</button>
                                <br /><br />
                                    ...
                                    {this.state.data.map(videos=>{
                                        return(
                                            <tr>
                                                ...
                                                <td>{videos.URL}</td>
                                                <td>
                                                    <button className="btn btn-primary" onClick={()=>{this.seleccionarVideo(videos); this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                                                    {"   "}
                                                    <button className="btn btn-danger" onClick={()=>{this.seleccionarVideo(videos); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                                </td>
                                            </tr>
                                        )
                                    })}
                                    ...
                                    <ModalBody>
                                        <div className="form-group">
                                            ...
                                            <input type="url" name="url" id="url"
                                                   ...
                                                   required onChange={this.handleChange} value={form?form.URL: ''}/>
                                            <br />
                                ...
                                <Modal isOpen={this.state.modalEliminar}>
                                    <ModalBody>
                                        Estás seguro que deseas eliminar el video {form && form.title} ?
                                    </ModalBody>
                                    <ModalFooter>
