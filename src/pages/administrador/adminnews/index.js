            ...
            <div >
                <div className="row">
                    ...
                    <div className="col-lg-10 " >
                        <div className="App">
                            <br /><br /><br />
                            <button className="btn btn-primary" onClick={()=>{this.setState({form: null, tipoModal: 'insertar'}); this.modalInsertar()}}>Agregar Noticia</button>
                            <br /><br />
                                ...
                                {this.state.data.map(news=>{
                                    return(
                                        <tr>
                                            ...
                                            <th><img src={news.imgURL}/></th>
                                            <td>
                                                <button className="btn btn-primary" onClick={()=>{this.seleccionarNoticia(news); this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                                                {"   "}
                                                <button className="btn btn-danger" onClick={()=>{this.seleccionarNoticia(news); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                            </td>
                                        </tr>
                                    )
                                })}
