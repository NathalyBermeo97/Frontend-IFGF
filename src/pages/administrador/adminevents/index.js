                ...
                <div >
                    <div className="row">
                        ...
                        <div className="col-lg-10 " >
                            <div className="App">
                                <br /><br /><br />
                                <button className="btn btn-primary" onClick={()=>{this.setState({form: null, tipoModal: 'insertar'}); this.modalInsertar()}}>Agregar Evento</button>
                                <br /><br />
                                    ...
                                    {this.state.data.map(events=>{
                                        return(
                                            <tr>
                                                ...
                                                <td>{events.imgURL}</td>
                                                <td>
                                                    <button className="btn btn-primary" onClick={()=>{this.seleccionarEvento(events); this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                                                    {"   "}
                                                    <button className="btn btn-danger" onClick={()=>{this.seleccionarEvento(events); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                                </td>
                                            </tr>
                                        )
                                    })}
                                ...
                                <Modal isOpen={this.state.modalEliminar}>
                                    <ModalBody>
                                        Estás seguro que deseas eliminar la noticia {form && form.title}
                                    </ModalBody>
                                    <ModalFooter>
