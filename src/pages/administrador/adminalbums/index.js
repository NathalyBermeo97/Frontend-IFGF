...
const url="https://backend-ifgf.herokuapp.com/api/albums";
                ...
                <div >
                    <div className="row">
                        ...
                        <div className="col-lg-10 " >
                            <div className="App">
                                <br /><br /><br />
                                <button className="btn btn-primary" onClick={()=>{this.setState({form: null, tipoModal: 'insertar'}); this.modalInsertar()}}>Agregar albums</button>
                                <br /><br />
                                    ...
                                    {this.state.data.map(albums=>{
                                        return(
                                            <tr>
                                                ...
                                                <td>{albums.imgURL}</td>
                                                <td>
                                                    <button className="btn btn-primary" onClick={()=>{this.seleccionarAlbums(albums); this.modalInsertar()}}><FontAwesomeIcon icon={faEdit}/></button>
                                                    {"   "}
                                                    <button className="btn btn-danger" onClick={()=>{this.seleccionarAlbums(albums); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                                </td>
                                            </tr>
                                        )
                                    })}
                                ...
                                <Modal isOpen={this.state.modalEliminar}>
                                    <ModalBody>
                                        Estás seguro que deseas eliminar la album {form && form.title} ?
                                    </ModalBody>
                                    <ModalFooter>
