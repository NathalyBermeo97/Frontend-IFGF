                        ...
                        <div className="col-lg-10 " >
                            <div className="App">
                                        ...
                                        return(
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {"   "}
                                                    <button className="btn btn-danger" onClick={()=>{this.seleccionarDonacion(donations); this.setState({modalEliminar: true})}}><FontAwesomeIcon icon={faTrashAlt}/></button>
                                                </td>
                                            </tr>
                                        )
                                    })}
                                ...
                                <Modal isOpen={this.state.modalEliminar}>
                                    <ModalBody>
                                        Estás seguro que deseas eliminar la donacion {form && form.title}
                                    </ModalBody>
                                    <ModalFooter>
