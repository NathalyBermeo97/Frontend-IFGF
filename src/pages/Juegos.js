                    ...
                    <div className={styles.cardjuegos}>
                        <div className="card-body">
                            ...
                            <p className="card-text">With supporting text below as a natural lead-in to additional
                                content.</p>
                            <a href="JuegoIglesia" className="btn btn-primary">Ver más</a>
                        </div>
                    </div>
                </div>
                <div className="col-sm-4">
                    <div className={styles.cardjuegos}>
                        <div className="card-body">
                            ...
                            <p className="card-text">With supporting text below as a natural lead-in to additional
                                content.</p>
                            <a href="Juegohistoria" className="btn btn-primary">Ver más</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-sm-4">
                    <div className={styles.cardjuegos}>
                        <div className="card-body">
                            ...
                            <p className="card-text">With supporting text below as a natural lead-in to additional
                                content.</p>
                            <a href="Juegosbiblia" className="btn btn-primary">Ver más</a>
                        </div>
                    </div>
                </div>
